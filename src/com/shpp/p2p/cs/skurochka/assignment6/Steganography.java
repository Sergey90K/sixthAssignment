...
public class Steganography extends SimpleProgram implements SteganographyConstants {
    ...
    private void hideMessage() {
        try {
            GImage e = com.shpp.p2p.cs.skurochka.assignment6.SteganographyLogic.hideMessage(this.toBooleanArray(this.getImage(this.drawing)), this.getImage(this.picture));
            if (e == null) {
